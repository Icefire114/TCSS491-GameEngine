...
import { DrawLayer, ForceDraw } from "../../engine/types.js";
...
export class Mountain extends ForceDraw implements Entity {
    ...
    public generatingAnchor() {
        ...
        else if (!this.bossGateActive && farEnoughFromSafeZoneExit && pastSpawnPoint && coolDownRavine && notNearSafeZone && this.rng.next() < 0.1) {
